...
<section class="instruments-section">
    <div class="container">
        ...
        <div class="sitetitle sitetitle-xl sitetitle-black sitetitle-center sitetitle-width900" data-aos="fade-up" data-aos-duration="500">
            <p>With X Open Hub’s offer you get access to liquidity on wide range of global indices. <br />Take advantage of our tight spreads on the most popular instruments: <br />UK 100, US 30, US 500, DE 30 and more.</p>
            <p>Thanks to our innovative financial solutions we can provide you with liquidity on indices with <br />best possible prices, execution and depth on the market.</p>
        </div>
        <!-- Title -->
