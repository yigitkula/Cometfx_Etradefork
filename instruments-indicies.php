            ...
            <div class="row">
                <div class="col">
                    <div class="headtitle-content-icons" data-aos="fade-in" data-aos-duration="1500" data-aos-delay="500">
                        <i class="icons-sprite sprite-headtitle-100 icons-indicies"></i>
                    </div>
                    <div class="headtitle-content-slogan">
                        ...
                        <h1 class="headtitle-content-slogan-title" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="0"><strong class="sitecolorblue">INDICIES</strong></h1>
                    </div>
                    <div class="headtitle-submenu">
                        <ul class="headsubmenu">
                            <li><a href="instruments-forex" title="FOREX" rel="category">FOREX</a></li>
                            <li class="active"><a href="instruments-indicies" title="INDICES" rel="category">INDICES</a></li>
...
<section class="instruments-section">
    <div class="container">
        ...
        <div class="sitetitle sitetitle-xl sitetitle-black sitetitle-center" data-aos="fade-up" data-aos-duration="500">
            <p>With Marketsall's offer you get access to liquidity on wide range of global indices. Take advantage of our tight spreads on the most popular instruments: UK 100, US 30, US 500, DE 30 and more. Both futures and cash indices.</p>
            <p>Thanks to our innovative financial solutions we can provide you with liquidity on indices with best possible prices, execution and depth on the market.</p>
        </div>
        <!-- Title -->
        ...
        <div class="instruments-section-table sitecontent">
            ...
            <!-- Title -->
            <div class="sitetitle sitetitle-xl sitetitle-black sitetitle-center" data-aos="fade-up" data-aos-duration="500">
                <h2>INDICIES INSTITUTIONAL <strong class="sitecolorblue">SPREADS</strong></h2>
            </div>
            <!-- Title -->
