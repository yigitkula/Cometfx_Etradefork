    ...
    <div class="headtitle-background headtitle-background-ins-forex">
        <div class="headtitle-content">
            <div class="headtitle-content-slogan">
                ...
                <h1 class="headtitle-content-slogan-title"><strong>E-TRADE <span class="sitecolorred">PRO</span></strong></h1>
            </div>
        </div>
    </div>
    <div class="headtitle-icons">
        <i class="icons-sprite sprite-headtitle-100 icons-etp"></i>
    </div>
</div>
<!-- Header Slogan -->
    ...
    <div class="container">
        ...
        <div class="platforms-head">
            ...
            <div class="sitetitle sitetitle-xl sitetitle-black sitetitle-center" data-aos="fade-up" data-aos-duration="500">
                <h2>DESIGNED FOR THE <strong class="sitecolorred">PROFESSIONALS</strong></h2>
            ...
            <div class="col-md-6">
                <div class="sitetitle-group">
                    <div class="sitetitle sitetitle-md sitetitle-black sitetitle-left" data-aos="fade-up" data-aos-duration="500">
                        <h2>E-TRADE <strong>PRO <span class="sitecolorred">WEB TRADING</span></strong></h2>
                    ...
                    <div class="sitetitle sitetitle-md sitetitle-black sitetitle-left" data-aos="fade-up" data-aos-duration="500">
                        <h2>E-TRADE <strong>PRO <span class="sitecolorred">MOBILE TRADING</span></strong></h2>
...
<section class="section-item foot-item foot-item-bggray">
    <div class="container">
        ...
        <div class="section-item-formarea formuinew formuilabel">
            <form action="" autocomplete="off" onsubmit="return formValidator.verifyProForm()" novalidate>
                <div class="form-row">
