            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="headtitle-content-slogan">
                        ...
                        <h1 class="headtitle-content-slogan-title" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="0"><strong class="sitecolorblue">COMMODITIES</strong></h1>
                    </div>
                    <div class="headtitle-submenu">
                        <ul class="headsubmenu">
                            ...
                            <li class="active"><a href="instruments-commodities" title="COMMODITIES" rel="category">COMMODITIES</a></li>
...
<section class="instruments-section">
    <div class="container">
        ...
        <div class="instruments-section-table sitecontent">
            ...
            <!-- Title -->
            <div class="sitetitle sitetitle-xl sitetitle-black sitetitle-center" data-aos="fade-up" data-aos-duration="500">
                <h2>COMMODITIES INSTITUTIONAL <strong class="sitecolorblue">SPREADS</strong></h2>
            </div>
            <!-- Title -->
