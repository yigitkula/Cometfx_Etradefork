    ...
    <div class="headtitle-background headtitle-background-ins-forex">
        <div class="headtitle-content">
            <div class="headtitle-content-slogan">
                ...
                <h1 class="headtitle-content-slogan-title"><strong class="sitecolorred">COMMODITIES</strong></h1>
            </div>
        </div>
    </div>
    <div class="headtitle-icons">
        <i class="icons-sprite sprite-headtitle-100 icons-commodities"></i>
    </div>
</div>
<!-- Header Slogan -->
...
<section class="instruments-section">
    <div class="container">
        ...
        <div class="sitetitle sitetitle-xl sitetitle-black sitetitle-center sitetitle-width900" data-aos="fade-up" data-aos-duration="500">
            <p>X Open Hub offers liquidity on major commodity sectors <br />including energy, precious metals, industrial metals, softs and agriculture. <br />Diversify your brokerage offering by broadening your portfolio with outstanding list of popular commodities.</p>
            <p>Check out our wide range of products from global markets and take advantage <br />from our ultra-fast execution and price feeds.</p>
        </div>
        <!-- Title -->
        ...
        <div class="instruments-section-table sitecontent">
            ...
            <div class="sitetitle sitetitle-xl sitetitle-black sitetitle-center" data-aos="fade-up" data-aos-duration="500">
                <h2>COMMODITIES INSTITUTIONAL <strong class="sitecolorred">SPREADS</strong></h2>
            </div>
            <!-- Title -->
