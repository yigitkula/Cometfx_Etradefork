    ...
    <div class="headtitle-background headtitle-background-ins-forex">
        <div class="headtitle-content">
            <div class="headtitle-content-slogan">
                ...
                <h1 class="headtitle-content-slogan-title"><strong class="sitecolorred">FOREX</strong></h1>
            </div>
        </div>
    </div>
...
<section class="instruments-section">
    <div class="container">
        ...
        <div class="sitetitle sitetitle-xl sitetitle-black sitetitle-center sitetitle-width900" data-aos="fade-up" data-aos-duration="500">
            <p>Foreign exchange is the world’s most widely traded financial market, with an estimated daily turnover exceeding $4 trillion. <br />X Open Hub offers liquidity for forex on more than 50 spot instruments with enhanced execution and competitive turnover fees. <br />Take advantage from our broad offer of professional services and get access the our liquidity pool today.</p>
            <p>Our highly experienced FX teams in London and Warsaw will provide you with <br />award winning advisory at every stage of our cooperation. </p>
        </div>
        <!-- Title -->
        ...
        <div class="instruments-section-table sitecontent">
            ...
            <div class="sitetitle sitetitle-xl sitetitle-black sitetitle-center" data-aos="fade-up" data-aos-duration="500">
                <h2>FOREX INSTITUTIONAL <strong class="sitecolorred">SPREADS</strong></h2>
            </div>
            <!-- Title -->
