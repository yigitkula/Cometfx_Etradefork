...
<section class="interaction interaction-section">
    <div class="container">
        ...
        <div class="interaction-section-btn">
            <a class="btn btn-lg btn-danger btn-gradient-red" href="#" rel="bookmark" title="CONTACT US" data-aos="fade-up" data-aos-duration="1500">CONTACT US</a>
        </div>
        <!-- Interaction Btn -->
