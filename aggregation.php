...
<!-- Aggregation Start -->
<section class="aggregation aggregation-section">
    <div class="container">
        ...
        <div class="aggregation-head">
            ...
            <!-- Banner -->
            <div class="aggregation-head-aggregation">
                <div class="aggregation-head-aggregation-img">
                    <img src="/assets/img/section/section_light_background_aggregation.jpg" alt="Aggregation" width="1133" height="479">
                </div>
